...
public class GildedRoseTest {
    ...
    public void initItems() {
        ...
        // Then
        assertThat(gildedRose.items).extracting("name")
                .containsExactly("+5 Dexterity Vest",
                        "Aged Brie",
        ...
        assertThat(gildedRose.items).extracting("sellIn")
                .containsExactly(10, 2, 5, 0, -1, 15, 10, 5, 3);

        assertThat(gildedRose.items).extracting("quality")
                .containsExactly(20, 0, 7, 80, 80, 20, 49, 49, 6);
    ...
    public void updateQualityWithItemsAfter100Days() {
        ...
        // Then
        assertThat(gildedRose.items).extracting("sellIn")
                .containsExactly(-90, -98, -95, 0, -1, -85, -90, -95, -97);

        assertThat(gildedRose.items).extracting("quality")
                .containsExactly(0, 50, 0, 80, 80, 0, 0, 0, 0);
    }
}
